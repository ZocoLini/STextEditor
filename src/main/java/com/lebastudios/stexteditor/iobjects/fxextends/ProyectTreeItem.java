...
import com.lebastudios.stexteditor.AppLoop;
...
public class ProyectTreeItem extends TreeItem<ProyectTreeCellContent>
{
    ...
    {
        TextEditorApplication.getStage().addEventHandler(WindowEvent.WINDOW_HIDING, (event) -> monitorear = false);
