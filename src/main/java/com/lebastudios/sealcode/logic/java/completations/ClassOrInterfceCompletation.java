...
public class ClassOrInterfceCompletation extends JavaNodeCompletation
{
    ...
    public TreeSet<JavaNodeCompletation> getChildren()
    {
        ...
        {
            JavaNodeCompletation nodeCompletation = JavaNodeCompletation.toJavaNode(member);
        ...
        for (var fields : classe.getFields())
        {
            ...
            {
                JavaNodeCompletation nodeCompletation = JavaNodeCompletation.toJavaNode(variable);
